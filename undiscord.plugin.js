 ...
 * @website https://github.com/ShiroBlank/Soxcord/blob/main/undiscord.plugin.js
 * @source https://raw.githubusercontent.com/ShiroBlank/Soxcord/main/undiscord.plugin.js
 * @updateUrl https://raw.githubusercontent.com/ShiroBlank/Soxcord/main/undiscord.plugin.js
 */
function undiscord() {
...
undiscord.prototype.getName = function () {
    return "Undiscord";
};
undiscord.prototype.getDescription = function () {
    return "Enables Undiscord on BetterDiscord";
};
undiscord.prototype.getVersion = function () {
    return "4.1";
};
undiscord.prototype.getAuthor = function () {
    return "victornpb (ported by Shiro)";
};
//undiscord.prototype.getSettingsPanel = function () {};

//undiscord.prototype.load = function () {};

//undiscord.prototype.unload = function () {};

undiscord.prototype.start = function () {
...
//undiscord.prototype.stop = function () {};
//undiscord.prototype.onMessage = function () {};
//undiscord.prototype.onSwitch = function () {};
